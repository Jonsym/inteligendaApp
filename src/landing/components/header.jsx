...
const Header = () => {
    return ( 
        ...
        <nav className="flex items-center space-x-4">
          ...
          <Link to={REGISTER} className="inline-block bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-700 font-semibold rounded-lg py-2 px-5 text-white ">Registrate</Link>
        </nav>
      </header>
     );
}
