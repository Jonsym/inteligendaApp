    ...
    return (
        <div className="relative bg-white">
            ...
            <div className="flex items-center justify-between p-4 text-gray-400 border-2 border-gray-100 border-dashed bg-gray-50">
                <p><PlusIcon className="inline w-6 mr-2 text-green-500"/> Crea tus actividades</p>
                <button onClick={() => handleAddTask()} type="button" className="bg-blue-600 button focus:outline-none hover:bg-blue-700 whitespace-nowrap">Nueva tarea</button>
            </div>
