        ...
        <aside className={`${css} ${openSidebar ? '-translate-x-0':'-translate-x-full'}`}>
            ...
            <div className="mt-2">
                ...
                <div className="px-10 lg:hidden">
                    <p className="mb-6 text-xl font-bold uppercase sm:tracking-wide">Menú</p>
                    <ul>
                        <li className="mb-4">
                            <Link to={HOME} className="text-gray-500 hover:text-gray-600 focus:outline-none"><ChevronRightIcon className={`inline w-6 mr-1`}/> Inicio</Link>
                        </li>
                        <li className="mb-4">
                            <Link to={TASKS} className="text-gray-500 hover:text-gray-600 focus:outline-none"><ChevronRightIcon className={`inline w-6 mr-1`}/> Actividad</Link>
                        </li>
                        <li className="mb-4">
                            <Link to={PROJECTS} className="text-gray-500 hover:text-gray-600 focus:outline-none"><ChevronRightIcon className={`inline w-6 mr-1`}/> Proyectos</Link>
                        </li>
                        <li className="mb-4">
