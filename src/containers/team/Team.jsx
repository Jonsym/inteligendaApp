    ...
    return ( 
        <Layout>
            ...
            <div className="flex justify-between p-2 border-b border-gray-100">
                <div className="p-2">
                    <h1 className="m-0 text-2xl font-bold text-gray-400">Equipo</h1>
                </div>
                <div className="p-2">
            ...
            <div className="p-4">
                <div className="flex justify-between px-8 mb-6">
                    <div className="w-full">
                        <p className="text-xl font-semibold ">Progreso de equipo</p>
                        {
                            !loadingUsers && <span className="text-sm text-gray-600">Hay {users.length} miembros</span>
                        }
                    ...
                    <div className="w-1/4 text-right">
                        <div className="flex items-center justify-start">
                            ...
                            <input onChange={searchItem} type="text" className="field-control" placeholder="Buscar miembro"/>
                        </div>
                    </div>
                </div>
                                        ...
                                        currentData.map(user => (
                                            <tr key={user._id} className="hover:bg-blue-50">
                                                ...
                                                <td className="px-8 py-4">
                                                    <div>
                                                        <div className="flex items-center justify-between">
                                                            <span className="block mb-1 mr-3 text-sm text-left text-gray-400">Progreso</span>
                                                ...
                                                <td className="text-gray-400" >
                                                    <span className="block text-sm">Unido</span>
