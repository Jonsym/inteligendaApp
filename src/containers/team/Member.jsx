    ...
    return ( 
        <Layout className="bg-gray-50">
            <div className="flex justify-between p-2 border-b border-gray-100">
                <div className="p-2">
                    <h1 className="m-0 text-2xl font-bold text-gray-400">Miembro</h1>
                </div>
                <div className="p-2">
                </div>
            </div>
                ...
                <div className="md:grid grid-cols-12 gap-6 mb-4">
                    ...
                    { member && <ProfileForm member={member} loading={loading} error={error} /> }
                        ...
                        <div className="px-4  sm:p-2">
                            <Card>
                                { !error && <Card.Header>{member.first_name}'s progreso</Card.Header> }
                        ...
                        <div className="px-4  sm:p-2">
                            <Card>
                                <Card.Header>Actividad creada <span className="text-sm ml-1 text-gray-300">( {created.length} )</span></Card.Header>
                                <Card.Body>
                                        ...
                                        !loadingTasks && !created.length && (
                                            <div className="flex items-center justify-center border border-gray-300 border-opacity-50 border-dashed rounded">
                                                <div className="w-full p-4 text-sm text-center text-gray-400">
                                                    {
                                                        error ? <></> : <div>{member.first_name} no ha creado ninguna actividad</div>
                                                    }
                                                </div>
                                            </div>
                                        )
                                            ...
                                            <Link to={DETAILS_TASK(task._id)}  key={task._id} className="flex items-center justify-between text-sm text-gray-500 rounded hover:bg-blue-50 focus:outline-none ">
                                                ...
                                                <div className="items-center justify-start hidden w-3/6 p-2 md:flex">
                                                    ...
                                                    <div className="w-full">
                                                        <span className="text-gray-400 mb-2">Asignado</span>
...
function ProfileForm({member, loading, error}) {
    ...
    return (
        <div>
                {
                    error && <div className="text-red-500 bg-red-100 alert">Hubo una carga del usuario <br/>{error}</div>
                }
                ...
                <div className="px-4 sm:p-2">
                    ...
                    <Card>
                        ...
                        <h3 className="font-bold text-lg mb-4 text-black">Contacto</h3>
                            ...
                            <div className="md:grid grid-cols-10 gap-5">
                                ...
                                <div className="col-span-5 md:flex items-center">
                                    {loading ? <InputLoader/> : (
                                        <>
                                            <span className="font-semibold mr-2">Unido: </span>
                            ...
                            <h3 className="font-bold text-lg my-4 text-black">Ubicación</h3>

                            <div className="md:grid grid-cols-10 gap-5">
                                <div className="col-span-5 md:flex items-center">
                                    {loading ? <InputLoader/> : (
                                        <>
                                            <span className="font-semibold mr-2">Ciudad/Región: </span>
                                ...
                                <div className="col-span-5 md:flex items-center">
                                    {loading ? <InputLoader/> : (
                                        <>
                                            <span className="font-semibold mr-2">Calle: </span>
