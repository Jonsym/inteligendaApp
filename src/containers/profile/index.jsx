    ...
    return ( 
        <Layout>
            <div className="flex justify-between p-2 border-b border-gray-100">
                <div className="p-2">
                    <h1 className="m-0 text-2xl font-bold text-gray-400">Perfil</h1>
                </div>
                <div className="p-2">
                </div>
            </div>
                ...
                <div className="md:grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-4">
                        <div className="mb-4 shadow-sm p-2">
                            <h4 className="mb-4 font-semibold text-gray-500">Configuración</h4>
                            <Link to={CHANGE_PASSWORD} className="button bg-transparent text-black shadow-none  rounded  block">Cambiar contraseña</Link>
                        </div>
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="overflow-hidden">
                ...
                {
                    uploadingError && <div className="text-red-500 bg-red-100 alert">Existe un problema al cargar tu avatar. <br/>{error}</div>
                }
                ...
                <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3">
                            <label htmlFor="first_name" className="block text-sm font-medium text-gray-700">Primer nombre</label>
                            { loading ? <InputLoader/> : 
                        ...
                        <div className="col-span-6 sm:col-span-6">
                            <label htmlFor="about" className="block text-sm font-medium text-gray-700">Sobre ti</label>
                            <div className="mt-1">
                            ...
                            <p className="mt-2 text-sm text-gray-500">Describete a ti mismo.</p>
                        </div>

                        <div className="col-span-6 sm:col-span-3">
                            <label htmlFor="email_address" className="block text-sm font-medium text-gray-700">Gmail</label>
                            { loading ? <InputLoader/> : 
                        ...
                        <div className="col-span-6 sm:col-span-3">
                            <label htmlFor="country" className="font-medium text-gray-700 ">Ciudad / Región</label>
                            { loading ? <InputLoader/> : 
                        ...
                        <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                            <label htmlFor="postal_code" className="block text-sm font-medium text-gray-700">Codigo Postal</label>
                            { loading ? <InputLoader/> : 
                        ...
                        <div className="col-span-6">
                            <label htmlFor="street_address" className="block text-sm font-medium text-gray-700">Calle</label>
                            { loading ? <InputLoader/> :   
