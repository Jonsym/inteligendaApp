    ...
    return ( 
        <Layout className="bg-gradient-to-b from-blue-500 lg:from-blue-400 to-blue-500">
            ...
            <div className="flex justify-between p-2 mb-4 border-b border-gray-50 border-opacity-30 lg:border-opacity-50">
                <div className="p-2">
                    <h1 className="m-0 text-2xl font-bold text-white">Tablero de actividades</h1>
                </div>
                <div className="p-2">
                </div>
            </div>
            ...
            <div className="px-4 lg:hidden">
                <div className="flex items-center justify-between p-4 text-gray-400 border border-gray-100 border-dashed rounded bg-gray-50">
                    <p><PlusIcon className="inline w-6 mr-2 text-green-500"/> Empieza a crear actividades</p>
                    <button onClick={handleAddTask} type="button" className="bg-blue-600 button focus:outline-none hover:bg-blue-700 whitespace-nowrap">Nueva actividad</button>
                </div>
            </div>
